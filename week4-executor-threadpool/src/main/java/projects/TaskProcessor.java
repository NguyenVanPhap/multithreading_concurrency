...
public class TaskProcessor {
    ...
    public TaskProcessor(int poolSize) {
        ...
        this.executor = null; // TODO: Use Executors.newFixedThreadPool(poolSize)
    }
    ...
    public <T> List<T> processTasks(List<Callable<T>> tasks) throws InterruptedException {
        ...
        // TODO: Submit all tasks
        List<Future<T>> futures = null; // TODO: Submit tasks
    ...
    public <T> List<T> processTasksWithCompletionService(List<Callable<T>> tasks) throws InterruptedException {
        ...
        CompletionService<T> completionService = null; // TODO: Create
     ...
     */
    public <T> List<T> processTasksWithTimeout(List<Callable<T>> tasks, long timeout, TimeUnit unit) 
    ...
    public void shutdown() {
        ...
        // TODO: Wait for termination với timeout 10 seconds
